...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<EnFazlaKitapAlan_Result> EnFazlaKitapAlan()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EnFazlaKitapAlan_Result>("EnFazlaKitapAlan");
        }
    }
}
